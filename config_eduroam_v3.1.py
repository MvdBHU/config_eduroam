#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# python 3, heeft de voorkeur. Script werkt ook met python 2
...
### Het drie keer openen van het bestand is niet heel efficiënt, maar
###     een bewuste keuze aangezien het bestand op die manier ook geheel
###     ongemoeid gelaten kan worden.
### origineel: v1.0, 10 juli 2017
### laatste wijziging: v3.1, 30 september 2020
...
COPYRIGHT = "{} {}, ©2018,2020 Hogeschool Utrecht\n".format(PROGRAM_NAME, PROGRAM_VERSION)
